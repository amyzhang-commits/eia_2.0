# THIS WAS MISCOPED - MERGER FUNCTION SHOULD NOT PUSH TOWARDS DIAGNOSIS RIGHT AWAY
# SAVE PATTERNS OF MISSINGNESS FOR LATER...pattern-searching too early 
# deprec_20260116
# made_20260115
#!/usr/bin/env python3
"""
...
def merge_folder_files(
    ...
    show_heatmap : bool, default True
        Whether to generate and display coverage heatmap.
